...
public interface GameState {
	...
	/**
	 * Returns the name of a state to change to if this state is ready to change
	 * to another state, or null otherwise.
	 */
	public String checkForStateChange();

	/**
	 * Loads any resources for this state. This method is called in a background
	 * thread before any GameStates are set.
	 */
