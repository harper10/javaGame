...
public class GameManager extends GameCore {
	...
	static final Logger log = Logger
			.getLogger("com.brackeen.javagamebook.tilegame");
	...
	public void init() {
		...
		resourceManager = new TileGameResourceManager(screen
				.getFullScreenWindow().getGraphicsConfiguration(),
		...
		gameStateManager.addState(new MainGameState(soundManager, midiPlayer,
				screen.getWidth(), screen.getHeight()));
		gameStateManager.addState(new SplashGameState("gamesplash.jpg"));
