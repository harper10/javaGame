...
public class TileGameResourceManager extends ResourceManager {
	...
	public void addBullet(Creature creature, TileMap map, boolean isRight,
			boolean isPlayer) {
		/*
		...
		// center the bullet
		bullet.setX(TileMapRenderer.tilesToPixels(tileX)
				+ (TileMapRenderer.tilesToPixels(1) - bullet.getWidth()) / 2);

		// bottom-justify the bullet
		bullet.setY(TileMapRenderer.tilesToPixels(tileY + 1)
				- bullet.getHeight());
		bullet.setStartX();
		if (isRight) {
