...
/**
 * The FilterSequence class is a SoundFilter that combines several SoundFilters
 * at once.
 * <p>
...
public class FilterSequence extends SoundFilter {
	...
	/**
	 * Creates a new FilterSequence object with the specified array of
	 * SoundFilters. The samples run through each SoundFilter in the order of
	 * this array.
	 */
	...
	/**
	 * Returns the maximum remaining size of all SoundFilters in this
	 * FilterSequence.
	 */
